...
class Model:
    ...
    def optimise(self, data, steps, param_ranges):
        ...
        # generate a series of steps for each parameter based on the computational limits specified
        ...
        candidate_params = np.stack(np.meshgrid(*value_series, copy=False)).T.reshape(-1, len(param_ranges))
